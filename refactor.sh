...
#删除原有镜像
docker rmi chth/springboot-springcloud-docker-kebernetes-eureka:1.0.0 2>/dev/null 1>&2
docker rmi chth/springboot-springcloud-docker-kebernetes-front:1.0.0  2>/dev/null 1>&2
docker rmi chth/springboot-springcloud-docker-kebernetes-service:1.0.0 2>/dev/null 1>&2
